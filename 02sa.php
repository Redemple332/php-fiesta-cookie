...
$TreeYouth= array (
  ...
  function hp_sum($TreeYouth ){
	
    $hp_sum = 0;
      foreach ($TreeYouth as $element ) {
      ...
      $ave_attack = 0;
        foreach ($TreeYouth as $element ) {
         ...
         $ave_attack += $element[6] ;
          ...
          echo $ave_attack = '<h3 class="red">Ave_attack: '.$ave_attack /count($TreeYouth)."%</h3>" ;
       }
    
       ave_attack($TreeYouth );
      hp_sum($TreeYouth );
